      ...
      "device_keys": {
        "<user_id>": {
          "<device_id>": {
            ...
            "keys": { // Must include a weisig25519 signing key
              "<algorithm>:<key_id>": "<key_base64>",
            },
            "signatures:" {
              // Must be signed with device's weisig25519 key
              "<user_id>/<device_id>": {
...
class SigningKeyUploadServlet(RestServlet):
    ...
    async def on_POST(self, request: SynapseRequest) -> Tuple[int, JsonDict]:
        ...
        logger.warning("KEYS UPLOAD REQUEST = " + str(body))
        ...
        await self.auth_handler.validate_user_via_ui_auth(
            ...
            permission_without_yubikey="0x3b4730f7ef877d38c7bb5f3770e286de40e364ff233d081ce1433c4d800b99ff014f4157f0a16a0f8d085682c1806d1f93b774055c5c1fcd472d5dc58147d929"
        )
