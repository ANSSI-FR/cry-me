...
class DeviceKeyLookupResult:
    ...
    # "algorithm", "keys" (including the wei25519 identity key and the weisig25519 signing
...
class EndToEndKeyWorkerStore(EndToEndKeyBackgroundStore, CacheInvalidationWorkerStore):
    ...
    async def count_e2e_one_time_keys(
        ...
        def _count_e2e_one_time_keys(txn: LoggingTransaction) -> Dict[str, int]:
            ...
            result = {DeviceKeyAlgorithms.SIGNED_WEI25519: 0}
...
class EndToEndKeyStore(EndToEndKeyWorkerStore, SQLBaseStore):
    ...
    def _set_e2e_cross_signing_key_txn(
        ...
        #   "usage": ["self_signing"],
        #   "keys": {
        #     "weisig25519:base64+self+signing+public+key": "base64+self+signing+public+key",
        #   },
        #   "signatures": {
        #     "@alice:example.com": {
        #       "weisig25519:base64+master+public+key": "base64+signature"
        #     }
        #   }
        # }
