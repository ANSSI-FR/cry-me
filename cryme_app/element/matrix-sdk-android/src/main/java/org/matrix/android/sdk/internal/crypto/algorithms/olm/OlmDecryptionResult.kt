...
data class OlmDecryptionResult(
        ...
        /**
         * The wei25519 key that the sender of the event is known to have ownership of.
         */
         ...
         */
        @Json(name = "forwardingWei25519KeyChain") val forwardingWei25519KeyChain: List<String>? = null
)
