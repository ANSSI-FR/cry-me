...
internal class MXMegolmEncryption(
    ...
    /*override suspend fun ensureOutboundSessionUsage(userIds: List<String>) {
        Timber.i("## MegolmEncryption : ensureOutboundSessionUsage")
        val devices = getDevicesInRoom(userIds)
        ensureOutboundSession(devices.allowedDevices)
    }*/
    ...
    private fun notifyWithheldForSession(devices: MXUsersDevicesMap<WithHeldCode>, outboundSession: MXOutboundSessionInfo) {
        ...
        cryptoCoroutineScope.launch(coroutineDispatchers.computation) {
            mutableListOf<Pair<UserDevice, WithHeldCode>>().apply {
                ...
                notifyKeyWithHeld(targets, outboundSession.sessionId, olmDevice.deviceWei25519Key, code)
            }
        }
    }
    ...
    private fun prepareNewSessionInRoom(): MXOutboundSessionInfo {
        ...
        keysClaimedMap["weisig25519"] = olmDevice.deviceWeiSig25519Key!!

        olmDevice.addInboundGroupSession(sessionId!!, olmDevice.getSessionKey(sessionId)!!, roomId, olmDevice.deviceWei25519Key!!,
    ...
    private suspend fun ensureOutboundSession(devicesInRoom: MXUsersDevicesMap<CryptoDeviceInfo>): MXOutboundSessionInfo {
        ...
        if (session == null ||
                ...
                session.needsRotation(sessionRotationPeriodMs) ||
    ...
    private fun encryptContent(session: MXOutboundSessionInfo, eventType: String, eventContent: Content): Content {
        ...
        map["sender_key"] = olmDevice.deviceWei25519Key!!
    ...
    private suspend fun getDevicesInRoom(userIds: List<String>): DeviceInRoomInfo {
        ...
        for (userId in keys.userIds) {
            ...
            for (deviceId in deviceIds) {
                ...
                if (deviceInfo.identityKey() == olmDevice.deviceWei25519Key) {
