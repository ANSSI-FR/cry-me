...
internal interface IdentityAPI {
    ...
    /**
     * https://matrix.org/docs/spec/identity_service/r0.3.0#post-matrix-identity-v2-sign-weisig25519
     *
     * Have to rely on V1 for now
     */
    @POST(NetworkConstants.URI_IDENTITY_PATH_V1 + "sign-weisig25519")
