    ...
    private fun decryptIfNeeded(event: Event, roomId: String) {
        try {
            ...
            event.mxDecryptionResult = OlmDecryptionResult(
                    ...
                    keysClaimed = result.claimedWeiSig25519Key?.let { k -> mapOf("weisig25519" to k) },
            ...
            if (e is MXCryptoError.Base) {
                ...
                cryptoService.sendFailureReceipt(roomId, event.eventId!!, e.technicalMessage)
            }
            else{
                cryptoService.sendFailureReceipt(roomId, event.eventId!!, e.toString())
            }
        }
    }
