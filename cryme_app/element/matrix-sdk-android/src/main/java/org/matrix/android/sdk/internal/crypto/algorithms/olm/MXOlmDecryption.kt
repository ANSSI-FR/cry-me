...
internal class MXOlmDecryption(
    ...
    override fun decryptEvent(event: Event, timeline: String): MXEventDecryptionResult {
        ...
        val messageAny = cipherText[olmDevice.deviceWei25519Key] ?: run {
            Timber.e("## decryptEvent() : our device ${olmDevice.deviceWei25519Key} is not included in recipients")
        ...
        val weisig25519 = recipientKeys["weisig25519"]

        if (weisig25519 != olmDevice.deviceWeiSig25519Key) {
            Timber.e("## decryptEvent() : Event ${event.eventId}: Intended recipient weisig25519 key $weisig25519 did not match ours")
        ...
        return MXEventDecryptionResult(
                clearEvent = payload,
                senderWei25519Key = senderKey,
                claimedWeiSig25519Key = keys["weisig25519"]
        )
    }
     ...
     *
     * @param theirDeviceIdentityKey the Wei25519 identity key of the sender.
