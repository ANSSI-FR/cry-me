...
import org.matrix.android.sdk.internal.auth.data.LoginAccreditationResponse
import org.matrix.android.sdk.internal.auth.data.LoginChallengeResponse
...
internal interface AuthAPI {
    ...
    /**
     * Get signature for accreditation
     */
    @GET(NetworkConstants.URI_API_PREFIX_PATH_R0 + "login?accreditation=True")
    suspend fun getAccreditation(): LoginAccreditationResponse

    /**
     * Get Challenge for signature
     */
    @GET(NetworkConstants.URI_API_PREFIX_PATH_R0 + "login?challenge=True")
    suspend fun getChallenge(): LoginChallengeResponse
