...
//    private var pendingEvents: MutableMap<String /* senderKey|sessionId */, MutableMap<String /* timelineId */, MutableList<Event>>> = HashMap()
                        ...
                        { olmDecryptionResult ->
                            ...
                            if (olmDecryptionResult.payload != null) {
                                MXEventDecryptionResult(
                                        ...
                                        senderWei25519Key = olmDecryptionResult.senderKey,
                                        claimedWeiSig25519Key = olmDecryptionResult.keysClaimed?.get("weisig25519"),
                                        forwardingWei25519KeyChain = olmDecryptionResult.forwardingWei25519KeyChain
                                                .orEmpty()
                                )
                            } else {
                                throw MXCryptoError.Base(MXCryptoError.ErrorType.MISSING_FIELDS, MXCryptoError.MISSING_FIELDS_REASON)
    ...
    override fun onRoomKeyEvent(event: Event, defaultKeysBackupService: DefaultKeysBackupService) {
        ...
        val forwardingWei25519KeyChain: MutableList<String> = ArrayList()
        ...
        if (event.getClearType() == EventType.FORWARDED_ROOM_KEY) {
            ...
            forwardedRoomKeyContent.forwardingWei25519KeyChain?.let {
                forwardingWei25519KeyChain.addAll(it)
            }
            ...
            forwardingWei25519KeyChain.add(senderKey)
            ...
            if (null == forwardedRoomKeyContent.senderClaimedWeiSig25519Key) {
                Timber.tag(loggerTag.value).e("forwarded_room_key_event is missing sender_claimed_weisig25519_key field")
                return
            }

            keysClaimed["weisig25519"] = forwardedRoomKeyContent.senderClaimedWeiSig25519Key
        } else {
            ...
            // inherit the claimed weisig25519 key from the setup message
