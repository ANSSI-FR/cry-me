...
#ifndef DEFAULT_OLM_CIPHER_H_
#define DEFAULT_OLM_CIPHER_H_
...
struct _default_olm_cipher;

struct _default_olm_cipher_ops {
    /**
     * Returns the length of the message authentication code that will be
     * appended to the output.
     */
    size_t (*mac_length)(const struct _default_olm_cipher *cipher);
...
struct _default_olm_cipher {
    const struct _default_olm_cipher_ops *ops;
...
OLM_EXPORT extern const struct _default_olm_cipher_ops _default_olm_cipher_ops;
 ...
 */
#define DEFAULT_OLM_CIPHER_INIT(KDF_INFO) {     \
    /*.base_cipher = */&_default_olm_cipher_ops ,\
